...
const AboutSeychelles = lazy(() =>
  import("./components/pages/AboutSeychelles")
);
      ...
      case "wedding":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Wedding {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "fine-dining-seychelles":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Dining {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "rooms-suites-seychelles":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <RoomSuites {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "sustainability":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Sustainability {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "about-us":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <About {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/de/${slug}`}
      ...
      case "contact":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Contact {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "leisure-inner":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <LeisureInner {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "whats-on":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Leisure {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "spa-wellness":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <SpaWellness {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "about-seychelles":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <AboutSeychelles {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "offers":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Offers {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "privacy-policy":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <PrivacyPolicy {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "terms-of-use":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <TermsofUse {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "covid-policy":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <CovidPolicy {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "faqs":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <FAQ {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "gallery":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <GalleryMain {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      case "blog":
        return [
          <Route
            ...
            exact
            render={(props) => (
              <Blog {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />,
          <Route
            path={`/fr/${slug}`}
      ...
      default:
        ...
        return (
          <Route
            path="*"
            component={(props) => (
              <Error404 {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />
        );
    }
      ...
      <Suspense fallback={""}>
        ...
        <Switch>
          <Route
            ...
            path="/"
            render={(props) => (
              <Hometwo {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />
          <Route
            exact
          ...
          <Route
            ...
            exact
            render={(props) => (
              <DiningInner {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />
          <Route
            path={`/fr/dining/:id`}
          ...
          <Route
            ...
            exact
            render={(props) => (
              <RoomsInner {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />
          <Route
            path={`/fr/rooms/:id`}
          ...
          <Route
            ...
            exact
            render={(props) => (
              <OffersInner {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />
          <Route
            path={`/fr/offers/:id`}
          ...
          <Route
            ...
            exact
            render={(props) => (
              <Blogdetails {...props} isMobile={isMobile} isTop={isTop} />
            )}
          />
          <Route
            path={`/fr/blogs/:id`}
          ...
          {pages && pages.length > 0 && pages?.map((x) => mapRoute(x.slug))}
